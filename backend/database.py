...
def get_db():
    ...
    if USE_POSTGRES:
        ...
        if is_supabase:
            ...
            # Try connection with IPv4 address if available, otherwise use hostname
            connection_host = ipv4_address if ipv4_address else host
            ...
            try:
                ...
                print(f"✓ Connected to Supabase: {connection_host}:{port}")
