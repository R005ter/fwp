...
def desktop_releases():
    ...
    return jsonify({
        ...
        "platforms": [
            ...
            {
                "os": "linux",
                "label": "Linux (Mint / Ubuntu / Debian)",
                "filename": "fwp-desktop-linux.deb",
                "url": f"{base}/fwp-desktop-linux.deb",
                "note": "Double-click in Files → Software Installer asks for password → installed.",
            },
        ],
